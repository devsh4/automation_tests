...
public class JyperionListener implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		String file = "C:\\Users\\Administrator.pay1lap-71-PC\\Google Drive\\screenshot"+(new Random().nextInt())+".png";
		...
		if (throwable != null) {
			...
			Font font = new Font(Font.TIMES_ROMAN, 18 , Font.BOLD, Color.DARK_GRAY);
			Chunk imdb=new Chunk("[SCREENSHOT!]", font);
